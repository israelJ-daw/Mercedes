...
si el tiempo el nuevo tiempo es menor, se modificará el tiempo en la sesión que ya existe en el array
y otra para eliminar del array (hay  que comprobar que existe, crea una función para ello).
Crea un archivo para la clase Piloto. */

var carrera= new Carrera;

carrera.agregarPiloto("irra", "lambo" , 2.23);

carrera.agregarPiloto("pepe", "ferrari" , 1.13);
 
carrera.agregarPiloto("juan", "porche", 3.1);

carrera.eliminar("pepe");


carrera.ordenarnombres();
